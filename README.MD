...
- [2026.03.10] [sgemm_tf32](./kernels/sgemm/) tf32 `Tensor-Core` kernel achiving 98~102% cuBLAS's performance (and waiting for improvement)🚀
...
- [sgemm_tf32](./kernels/sgemm/)
  ...
  - [x] sgemm_tf32_bshfl_swizzle_bcf_dbf (cp.async读写A/B，warp shuffle b寄存器转置， As/Bs无冲突, grid swizzling，double buffer，95~98% cuBLAS 性能, stay tuned)
