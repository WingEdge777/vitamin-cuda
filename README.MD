...
- [2026.04.03] [hgemm_120](./kernels/hgemm_sm120/) fp16/bf16 `Tensor-Core` kernel outperforming cuBLAS `TMA copy + 3 stages' pipeline + double register buffer + swizzle + ldmatrix + mma`🚀
